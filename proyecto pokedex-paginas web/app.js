...
// Práctica 8: Bucle asíncrono para traer a los 1000
...
// localiza esta función de tus prácticas anteriores y modifícala así:
function crearTarjetaAPI(pokemon) {
    ...
    // ¡ESTA ES LA LÍNEA NUEVA PRÁCTICA!
    // Le decimos a la tarjeta que, al darle clic, ejecute abrirModal con sus datos.
...
inputBuscador.addEventListener('keyup', (evento) => {
    ...
    const textoBuscada = evento.target.value.toLowerCase();
    ...
    tarjetas.forEach(tarjeta => {
        ...
        if (nombrePokemon.includes(textoBuscada)) {
